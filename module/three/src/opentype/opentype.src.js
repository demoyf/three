...
function loadFromUrl(url, callback, data) {
/*     axios.post(url, {
        substring: encodeURIComponent(JSON.stringify(data.substring)),
    }, {
...
},{"./encoding":3,"./font":4,"./glyph":5,"./parse":7,"./path":8,"./tables/cff":10,"./tables/cmap":11,"./tables/glyf":12,"./tables/gpos":13,"./tables/head":14,"./tables/hhea":15,"./tables/hmtx":16,"./tables/kern":17,"./tables/loca":18,"./tables/maxp":19,"./tables/name":20,"./tables/os2":21,"./tables/post":22}],7:[function(require,module,exports){
